...
const EditPlayerPage = () => {
  ...
  const { getPlayerById, updatePlayer } = usePlayerData();
    ...
    return (
      <MainLayout title="Player Not Found">
        <div className="text-center">
          <p className="text-lg mb-4">The player you're trying to edit doesn't exist or has been removed.</p>
  ...
  return (
    <MainLayout title={`Edit Player: ${player.name} ${player.surname}`}>
      <div className="mb-6">
        <Button
          variant="outline"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update the player's details in the system
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
